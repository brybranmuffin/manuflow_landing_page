              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    className="bg-slate-700 border-slate-600 text-slate-50 placeholder-slate-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
                    placeholder="Tell us about your use case and what you hope to achieve..."
                  />
                </div>
                ...
                <div className="text-center">
                  <Button
                    ...
                    className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white font-semibold py-4 px-12 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                  >
      ...
      <section id="team" className="py-20 bg-slate-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              A diverse group of innovators, engineers, and visionaries building the future of business technology.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {teamMembers.map((member, index) => (
              <Card
                key={index}
                className="bg-slate-800 border-slate-700 text-center hover:border-blue-500/50 transition-all duration-300 transform hover:-translate-y-2"
              >
                <CardContent className="p-6">
                  <img
                    src={member.image}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-slate-300 mb-4 max-w-md">
                Building the future of business automation with cutting-edge AI and innovative design.
              </p>
          ...
          <div className="border-t border-slate-800 pt-8 text-center">
            <p className="text-slate-400">
              © 2024 TechFlow. All rights reserved. Built with passion for innovation.
            </p>
          </div>
        </div>
      </footer>
